...
<li class="col-md-2 col-sm-2 col-xs-12 btn"><a href="cerrarSesion.php">Cerrar sesión</a></li>
  ...
  <title>Taller de Guepetto</title>
  <style >
    .menu-general {
margin: 8px;
padding: 0;
...
<div class="container-fluid border-3 w-100 p-1 bg-dark text-white text-center">
  <h1 class="display-1" >TALLER DE GUEPETTO</h1>
  <p>¡Hecha un vistazo a nuestra biblioteca!</p> 

</div>
<a href="https://biblioteca.usbmed.edu.co/"><img src="../6.jpg" width=100% height=685px></a>
</body>
</html>